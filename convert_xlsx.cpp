#include <iostream>
#include <windows.h>
#include "C:/libxl-4.1.2/include_cpp/libxl.h"
#include <vector>
#include <string>
#include <sstream>
...
void  addtotable(std::vector<std::vector<std::pair<std::string, std::pair<int, int>>>> sheetinfo) {
    ...
    //}
    //������� ��� ���������� ���������� �� ������� � ������,writetocell(std::string, int, int)/ ��� ��� ��� ������ ������
    //��� ������ �� ���� ����� ����������� � ���� std::string, ��� ������� ���� ���� � ��
}

std::vector<std::vector<std::pair<std::string, std::pair<int, int>>>> readfromfile(const wchar_t* filename)
{
    //������(������(����(����, ����������)))
